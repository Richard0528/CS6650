...
//    private final static int RMQ_POOL_SIZE = 1;
    private final static int RMQ_POOL_SIZE = 20;
...
//            currChannel.basicPublish(EXCHANGE_NAME, ROUTING_KEY, null, SerializationUtils.serialize(validSwipe));
            currChannel.basicPublish(EXCHANGE_NAME, ROUTING_KEY, MessageProperties.MINIMAL_PERSISTENT_BASIC, SerializationUtils.serialize(validSwipe));
