...
@WebServlet(name = "TwinderServletWithMQ", value = "/TwinderServletWithMQ")
public class TwinderServletWithMQ extends HttpServlet {

    private final static String RMQ_HOST = "localhost";
//    private final static String RMQ_HOST = "<rmq-ec2-Public IPv4 DNS>";
    private final static int RMQ_POOL_SIZE = 10;
